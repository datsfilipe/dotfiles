...
<img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/datsfilipe/dotfiles?colorA=78a9ff&colorB=f4f4f4&style=for-the-badge&logo=github">
<img alt="GitHub issues" src="https://img.shields.io/github/issues/datsfilipe/dotfiles?colorA=78a9ff&colorB=f4f4f4&style=for-the-badge&logo=github">
...
- To add a new host, create a host definition in `hosts/`. You can now toggle features by importing the scanner and enabling specific modules (e.g., `modules.desktop.wm.niri.system.enable = true`).
...
- `flake.nix` is the authoritative definition of the repository inputs and outputs.
